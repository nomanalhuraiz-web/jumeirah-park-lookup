...
.app-header {
    background: linear-gradient(135deg, #080f1a 0%, #0c1c32 100%);
...
.app-title {font-size: 22px; font-weight: 700; color: #ffffff; margin: 0;}
.app-sub {font-size: 11px; color: #4a90c4; letter-spacing: 2px; text-transform: uppercase; margin: 0 0 6px;}
.stat-block {margin-left: auto; text-align: right;}
.stat-n {font-size: 24px; font-weight: 700; color: #4a90c4; line-height: 1;}
.stat-l {font-size: 10px; color: #3a6080; text-transform: uppercase; letter-spacing: 1px;}

.sec-card {border-radius: 12px; margin-bottom: 12px; overflow: hidden; border: 1px solid;}
.s22  {border-color: #1a3a5c; background: #080f1e;}
.s23  {border-color: #1a3c28; background: #060f0c;}
.s24  {border-color: #3c2010; background: #110a04;}
.s25a {border-color: #2e1a4a; background: #0e0618;}
.s25b {border-color: #3c1028; background: #110608;}

.sec-hd {display: flex; align-items: center; gap: 12px; padding: 13px 20px; border-bottom: 1px solid rgba(255,255,255,0.05);}
.ytag {font-size: 10px; font-weight: 700; letter-spacing: 2px; padding: 3px 10px; border-radius: 5px;}
.y22  {background: #0d2440; color: #4a90c4;}
.y23  {background: #0a1f14; color: #3cb870;}
.y24  {background: #1c1008; color: #d47830;}
.y25a {background: #160a24; color: #a060e0;}
.y25b {background: #1a0810; color: #d04880;}
.slbl {font-size: 13px; color: #607890; font-weight: 500;}

.info-tbl {width: 100%; border-collapse: collapse;}
.info-tbl tr {border-bottom: 1px solid rgba(255,255,255,0.04);}
.info-tbl tr:last-child {border: none;}
.info-tbl td {padding: 10px 20px; font-size: 13px; vertical-align: top;}
.info-tbl td.lbl {color: #507080; width: 38%; font-weight: 500;}
.info-tbl td.val {color: #c8d8e8; word-break: break-word;}
.nodata {padding: 14px 20px; font-size: 13px; color: #2a4060; font-style: italic;}

.pills {display: flex; gap: 8px; flex-wrap: wrap; margin-bottom: 20px;}
.pill  {font-size: 11px; font-weight: 600; padding: 4px 14px; border-radius: 20px;}
.p22  {background: #0d2440; color: #4a90c4; border: 1px solid #1a3a5c;}
.p23  {background: #0a1f14; color: #3cb870; border: 1px solid #1a3c28;}
.p24  {background: #1c1008; color: #d47830; border: 1px solid #3c2010;}
.p25a {background: #160a24; color: #a060e0; border: 1px solid #2e1a4a;}
.p25b {background: #1a0810; color: #d04880; border: 1px solid #3c1028;}
.pno  {background: #0c1520; color: #2a4060; border: 1px solid #162030; opacity: .6;}

.villa-id {font-size: 28px; font-weight: 700; color: #ffffff; margin-bottom: 8px; letter-spacing: .5px;}
.not-found {background: #1a0808; border: 1px solid #4a1010; border-radius: 10px; padding: 16px 20px; color: #c05050; font-size: 14px;}
</style>
...
# ── Field map ─────────────────────────────────────────────────────────────────
SECTIONS = [
    ("2022","CRM Owner Record","s22","y22","p22",[
    ...
    ("2023","Municipality Registry","s23","y23","p23",[
    ...
    ("2024","Transaction Log","s24","y24","p24",[
    ...
    ("2025","Registry — Before April","s25a","y25a","p25a",[
    ...
    ("2025","Transactions — April to December","s25b","y25b","p25b",[
...
def render(row):
    ...
    pills = ""
    for yr, lbl, sc, yc, pc, fields in SECTIONS:
...
if search:
    ...
    st.markdown("""
    <div style='text-align:center;padding:70px 0;color:#2a4060;'>
      <div style='font-size:40px;margin-bottom:16px;'>🏘</div>
      <div style='font-size:14px;'>Enter a Villa Number or Property ID to view full details</div>
      <div style='font-size:12px;margin-top:10px;color:#1e3050;'>
        JPB3VL001 · JPMVIL047 · JPN3VL027 · JPA3VL001 · JPT4V043
      </div>
    </div>""", unsafe_allow_html=True)
